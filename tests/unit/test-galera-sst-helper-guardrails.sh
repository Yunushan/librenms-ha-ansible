...
main() {
    ...
    require_text "${REPAIR_TASKS}" 'hostvars[item].librenms_mariadb_socket'
    require_text "${REPAIR_TASKS}" 'Initialize healthy Galera peers before SST helper repair'
    require_text "${REPAIR_TASKS}" 'Peer probe results:'
