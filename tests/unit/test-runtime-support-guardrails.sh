...
main() {
    ...
    contains "${DEFAULTS_FILE}" '- "3.15"'
    contains "${DEFAULTS_FILE}" 'librenms_python_315_preview_enabled: false'
    contains "${DEFAULTS_FILE}" 'librenms_python_315_min_ansible_core_version: "2.22.0"'
    ...
    contains "${COMMON_TASKS_FILE}" 'librenms_python_315_ansible_core_prerelease'
    contains "${COMMON_TASKS_FILE}" 'librenms_python_315_ansible_core_22_prerelease'
    contains "${COMMON_TASKS_FILE}" 'Validate Python 3.15 Ansible compatibility contract'
